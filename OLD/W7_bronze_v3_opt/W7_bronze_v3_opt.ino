...
void distPoll() {
  ...
  duration = pulseIn(echo, HIGH);  //timeout delay in microseconds
...
void wifiPoll() {
  ...
  if (repTime1c - repTime1p > 5000) {
    ...
    //solution maybe disabling interrupts aorund the lines transmitting data?
    //sounds like this can potentially cause issues and would explain why these lines appeared to be the sources of errors
