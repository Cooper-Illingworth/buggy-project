...
//variabls for keeping the arduino running or paused
bool run = false;
bool pause = true;
...
void travel() {
  //find the average amount of state changes from the encoders, divides by state changes per revolution
  //multiplies this value by circumference to get total distance traveled in cm;
